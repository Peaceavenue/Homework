...
async function visitGoogle() {
  ...
  const login = await driver.findElement(By.xpath('(//*[@class="large-6 small-12 columns"]/*[@name="username"])'));
  ...
  const flash = await driver.findElement(By.xpath('(//*[contains(text(), "Your")])'));
  ...
  const flashMessage = await driver.findElement(By.xpath('(//*[contains(text(), "Your")])')).getText();
  assert.equal(flashMessage,  'Your username is invalid!\n×');

  await driver.quit();
  console.log(flashMessage);
  console.log("An error message has been printed and contains the correct error message");
}
...
async function visitGoogle1() {
  ...
  const check = await driver.findElement(By.xpath('(//*[@id="checkboxes"]/input[2])'));
...
async function visitGoogle2() {
  ...
  await driver.manage().window().maximize();
  await driver.get("https://the-internet.herokuapp.com/checkboxes");
  await driver.findElement(By.xpath('(//*[@id="checkboxes"]/input[1])')).click();
  const checkOn = await driver.findElement(By.xpath('(//*[@id="checkboxes"]/input[1])'));
...
async function visitGoogle3() {
  ...
  await driver.manage().window().maximize();
  await driver.get("https://the-internet.herokuapp.com/login");
  const log = await driver.findElement(By.xpath('(//*[@class="large-6 small-12 columns"]/*[@name="username"])'));
  ...
  const flashMessage = await driver.findElement(By.xpath('(//*[@id="flash"])')).getText();
  ...
  await driver.quit();
  console.log(flashMessage);
  console.log ("Successful authorization and transition to the form page upon deauthorization")
}
...
async function visitGoogle4() {
  ...
  const textModal = await driver.findElement(By.xpath('(//*[contains(text(),"It\'s")])')).getText();
